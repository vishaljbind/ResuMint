...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Students often make silly mistakes on their resume by using inconsistent bullet points or font sizes. ResuMint’s auto format feature is a great help to ensure consistent format.",
    name: "Ms. Neha singh",
    title: "Educator",
  },
  {
    ...
    quote:
      "I used ResuMint during my last job search and was invited to interview at top tech companies such as Google and Amazon thanks to its slick yet professional resume design.",
    name: "Pradeep",
  ...
  },
  {
    ...
    quote:
      "Creating a professional resume on ResuMint is so smooth and easy! It saves me so much time and headache to not deal with google doc template.",
    name: "Poonam ",
