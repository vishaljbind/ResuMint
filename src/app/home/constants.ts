...
export const END_HOME_RESUME: Resume = {
  ...
  educations: [
    {
      ...
      gpa: "8.5",
      descriptions: [
        "Won 1st place in 2023 Education Hackathon, 2nd place in 2023 Health Tech Competition",
  ...
  projects: [
    {
      project: "Resume Builder and Parser",
      date: "Jan 2024",
      descriptions: [
