  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the ResuMint
      ...
      <Paragraph>
        And that is everything about the ResuMint parser algorithm :)
      </Paragraph>
      <Paragraph>
        Written by{" "}
        <Link href="https://github.com/vishaljbind">Vishal bind</Link> on march
        2024
      </Paragraph>
    </article>
  );
